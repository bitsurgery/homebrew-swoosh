...
class Swoosh < Formula
  ...
  on_macos do
    on_arm do
      ...
      url "https://github.com/bitsurgery/swoosh/releases/download/v0.1.8/swoosh-0.1.8-aarch64-apple-darwin.tar.gz"
      sha256 "163716f85cdd273ee258d575f6d862a7e5b31149e00c7432c8329df32b89378b"
    end
